 ...
 */
function(){"use strict";function e(){var e,t=document.createElement("div"),n={transition:"transitionend",OTransition:"otransitionend",MozTransition:"transitionend",WebkitTransition:"webkitTransitionEnd"};for(e in n)if(n.hasOwnProperty(e)&&void 0!==t.style[e])return n[e];return!1}function t(e){var t=e.style.height;e.style.height="auto";var n=getComputedStyle(e).height;return e.style.height=t,e.offsetHeight,n}function n(e){e.classList.remove("collapse"),e.classList.add("collapsing"),e.style.height=t(e),s?e.addEventListener(s,function(){i(e)},!1):i(e)}function r(e){e.classList.remove("collapse"),e.classList.remove("in"),e.classList.add("collapsing"),e.style.height=getComputedStyle(e).height,e.offsetHeight,e.style.height="0px"}function i(e){e.classList.remove("collapsing"),e.classList.add("collapse"),"0px"!==e.style.height&&(e.classList.add("in"),e.style.height="auto")}function a(e){e=e||window.event;var t=e.currentTarget||e.srcElement,i=t.getAttribute("data-target"),a=document.querySelector(i);return a.classList.contains("in")?r(a):n(a),!1}for(var s=e(),l=document.querySelectorAll("[data-toggle=collapse]"),o=0,c=l.length;c>o;o++)l[o].onclick=a}();